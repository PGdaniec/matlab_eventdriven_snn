    ...
    function ptc_fun(postidx, extInputSyn_idx, isExtInput) 
        ...
        for i_l = postidx
            ...
            if(use_synW_adaption && ~isExtInput)
                ...
                if(lastSpikeTimeOfNeuron(i_l)>=0 && ...
                    ...
                    synW_mat(syn_idx,j) = synW_mat(syn_idx,j) * synW_dec_scale;
            ...
            if(use_synWin_adaption && isExtInput)
                ...
                if(lastSpikeTimeOfNeuron(i_l)>=0 && ...
                    ...
                    synWin_mat(extInputSyn_idx,i_l) = ...
                        synWin_mat(extInputSyn_idx,i_l) * synW_dec_scale;
                end
            end
        ...
        if(use_synW_adaption && ~isExtInput)
            ...
            if(n_idx ~= 0 && phishift-lastSpikeRX(atTime,j) < deltaPhi_synW_change)
                ...
                synW_mat(n_syn_idx,n_idx) = ...
                    max(min(synW_mat(n_syn_idx,n_idx)*synW_inc_scale,...
                            synW_inc_limit_exc),...
                        -synW_inc_limit_inh);
        ...
        if(use_synWin_adaption && isExtInput)
            ...
            if(input_syn_idx ~= 0 && phishift-lastInputSpikeRX(atTime,j) < deltaPhi_synW_change)
                ...
                synWin_mat(input_syn_idx,j) = ...
                    max(min(synWin_mat(input_syn_idx,j)*synW_inc_scale,...
                            synW_inc_limit_exc),...
                        -synW_inc_limit_inh);
            end
        end
